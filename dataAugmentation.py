...
class DataAugmentation:
    ...
    def streching(self, tradingEnv, factor=1):
        ...
        for i in range(1, len(newTradingEnv.data.index)):
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Close')] = newTradingEnv.data.iloc[i-1, newTradingEnv.data.columns.get_loc('Close')] * (1 + returns.iloc[i])
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Low')] = newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Close')] * tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('Low')]/tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('Close')]
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('High')] = newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Close')] * tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('High')]/tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('Close')]
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Open')] = newTradingEnv.data.iloc[i-1, newTradingEnv.data.columns.get_loc('Close')]
    ...
    def noiseAddition(self, tradingEnv, stdev=1):
        ...
        for i in range(1, len(newTradingEnv.data.index)):
            ...
            price = newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Close')]
            volume = newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Volume')]
            ...
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Close')] *= (1 + priceNoise/100)
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Low')] *= (1 + priceNoise/100)
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('High')] *= (1 + priceNoise/100)
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Volume')] *= (1 + volumeNoise/100)
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Open')] = newTradingEnv.data.iloc[i-1, newTradingEnv.data.columns.get_loc('Close')]
    ...
    def lowPassFilter(self, tradingEnv, order=5):
        ...
        for i in range(order):
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Close')] = tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('Close')]
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Low')] = tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('Low')]
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('High')] = tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('High')]
            newTradingEnv.data.iloc[i, newTradingEnv.data.columns.get_loc('Volume')] = tradingEnv.data.iloc[i, tradingEnv.data.columns.get_loc('Volume')]
        newTradingEnv.data['Open'] = newTradingEnv.data['Close'].shift(1)
        newTradingEnv.data.iloc[0, newTradingEnv.data.columns.get_loc('Open')] = tradingEnv.data.iloc[0, tradingEnv.data.columns.get_loc('Open')]
